...
import { determineSeverity, generateFingerprint, getRelativePath } from '../src/functions.js';
...
test('determineSeverity returns correct severity levels', (t) => {
  t.is(determineSeverity(1), 'minor');
  t.is(determineSeverity(2), 'major');
  t.is(determineSeverity(0), 'info');
